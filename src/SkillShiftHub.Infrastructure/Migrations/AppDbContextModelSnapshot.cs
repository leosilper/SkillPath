...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.Plan", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.PlanItem", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.Skill", b =>
            {
                b.Property<int>("Id")
                    .HasColumnType("int");
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.User", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.Course", b =>
            {
                b.HasOne("SkillShiftHub.Domain.Entities.Skill", "Skill")
                    .WithMany("Courses")
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.Plan", b =>
            {
                b.HasOne("SkillShiftHub.Domain.Entities.User", null)
                    .WithMany("Plans")
        ...
        modelBuilder.Entity("SkillShiftHub.Domain.Entities.PlanItem", b =>
            {
                b.HasOne("SkillShiftHub.Domain.Entities.Plan", null)
                    .WithMany("Items")
                    .HasForeignKey("PlanId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("SkillShiftHub.Domain.Entities.Skill", null)
                    .WithMany()
                    .HasForeignKey("SkillId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();
