...
public class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        // You can override this by setting the SKILLPATH_MIGRATIONS_CONNECTION environment variable
        var connectionString = Environment.GetEnvironmentVariable("SKILLPATH_MIGRATIONS_CONNECTION")
